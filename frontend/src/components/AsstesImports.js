export const AI_ROBOT = require('../Assets/Lottie/Ai_Robot.json')
export const TEA = require('../Assets/Lottie/tea.json')
export const WaveLoop= require('../Assets/Lottie/WaveLoop.json')
